...
import com.sodas.sodacommon.security.exception.*;
...
public class SodaWebResponseExceptionTranslator implements WebResponseExceptionTranslator {
    ...
    private ResponseEntity<OAuth2Exception> handleOAuth2Exception(OAuth2Exception e) {
        ...
        return new ResponseEntity<>(new SodaAuth2Exception(e.getMessage(), e.getOAuth2ErrorCode()), headers,
